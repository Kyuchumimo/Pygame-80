...
A set of functions from TIC-80 tiny computer platform ported to Pygame 2 + Python 3. Many of them are designed to work with the NumPy library to improve performance, per pixel access and CSV files access.  
